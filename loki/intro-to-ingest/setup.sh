...
cd loki-fundamentals && git checkout intro-to-ingesting || { echo "Failed to checkout branch"; exit 1; }
...
sudo apt-get install -y figlet; clear; echo -e "\e[32m$(figlet -f standard 'Intro to')\e[0m"; echo -e "\e[33m$(figlet -f standard 'Ingesting')\e[0m"